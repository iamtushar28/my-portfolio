  ...
  return ( 
    <section className="pt-32 px-5 sm:px-10">
      <div className="flex flex-col max-w-7xl mx-auto">
        {/* title */}
        <h2 className='text-3xl md:text-7xl md:mb-4 mb-2'>Turning ideas into <br /> <span className='capitalize text-[#24cfa6] font-extrabold'>products</span> that matter.</h2>
