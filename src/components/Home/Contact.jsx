const Contact = () => {
  return ( 
    <section className="py-[50px] flex flex-col items-center bg-hero text-center">
      ...
      <p className="text-base lg:text-xl tracking-[0.6px]"><span className="font-bold">Contact me : </span><a href="mailto:iamtushar2830@gmail.com">iamtushar2830@gmail.com</a></p>
    </section>
   );
}
